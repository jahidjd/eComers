        ...
        <div class="main_content_iner overly_inner ">
            <div class="container-fluid p-0 ">
                <div class="row">
                    ...
                    <form action="<?php echo base_url('admin/Admin/update_purchase') ?>" method="post">
                    <input type="hidden" name="id" value="<?php echo $dataList->id ?>">
                        <table class="table table-bordered">
                            <tr>
                                <td>Product Name</td>
                                <td><input type="text" name="name" class="form-control" value="<?php echo $dataList->name ?>"></td>
                                <td>Category Name</td>
                                <td>
                                    <select name="product_category" id="" class="form-control">
                                        <option value="<?php echo $dataList->category_id ?>"><?php echo $dataList->categoryName ?></option>
                            ...
                            <tr>
                                ...
                                <td><input type="number" name="price" class="form-control" value="<?php echo $dataList->price ?>"></td>
                                <td>Purchase Quantity(kg)</td>
                                <td><input type="number" name="qty" class="form-control" value="<?php echo $dataList->qty ?>"></td>                                
                            </tr>
                            <tr>
                                <td>Date</td>
                                <td><input type="date" class="form-control" name="date" value="<?php echo $dataList->date ?>"></td>
                                <td colspan="2"><input type="submit" class="btn btn-primary form-control" value="Insert"></td>
                            </tr>
                        </table>
                    </form>
                </div>
