            ...
            <div class="container-fluid p-0 ">
                <div class="row">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php $sl=0;foreach($list as $order){ ?>
                                        <tr>
                                            <td><?php echo ++$sl ?></td>
                                            ...
                                            <!-- <td><?php // echo $order->categoryName ?></td> -->
                                            ...
                                            <td>Within 7 days</td>
                                            <td>
                                                <form action="<?php echo base_url('admin/Admin/orderStatus/') ?><?php echo $order->order_id  ?>" method='post'>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url('admin/Admin/orderDetails/') ?><?php echo $order->order_id ?>" class="btn btn-primary">View</a>
                                            </td>
                                        </tr>
                                <?php } ?>
                        </tbody>
