            ...
            <div class="container-fluid p-0 ">
                <div class="row">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php $sl=0;foreach($customer as $c){ ?>
                                    <tr>
                                        <td><?php echo ++$sl ?></td>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('admin/Admin/deleteCustomer/') ?><?php echo $c->id ?>" class="btn btn-danger" onclick="return confirm('Are you sure!!')">Delete</a>
