    ...
    <section class="main_content dashboard_part large_header_bg">
        ...
        <div class="main_content_iner overly_inner ">
            <div class="container-fluid p-0 ">
                <div class="row">
                    <h1>Add Purchase</h1>
                    <form action="<?php echo base_url('admin/Admin/addPurchase') ?>" method="post">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td><input type="number" name="price" class="form-control" placeholder="Price per kg"></td>
                                <td>Purchase Quantity(kg)</td>
                                <td><input type="number" name="qty" class="form-control" placeholder="Purchase Quantity (KG)"></td>                                
                            </tr>
                            <tr>
                                <td>Date</td>
