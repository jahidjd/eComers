            ...
            <div class="container-fluid p-0 ">
                <div class="row">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php $sl=0;foreach($purchase_list as $pr){ ?>
                                    <tr>
                                        <td><?php echo ++$sl ?></td>
                                        <td><?php echo $pr->name ?></td>
                                        <td><?php echo $pr->categoryName ?></td>
                                        <td><?php echo $pr->price ?></td>
                                        <td><?php echo $pr->qty ?> kg</td>
                                        <td><?php echo $pr->total ?></td>
                                        <td><?php echo $pr->date ?></td>
                                        <td>
                                            <a href="<?php echo base_url('admin/Admin/editPurchase/') ?><?php echo $pr->id ?>" class="btn btn-info">Edit</a>
                                            <a href="<?php echo base_url('admin/Admin/deletePurchase/') ?><?php echo $pr->id ?>" class="btn btn-danger" onclick="return confirm('Are You Sure!!')" >Delete</a>
