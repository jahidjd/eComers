                        ...
                        <div class="header_notification_warp d-flex align-items-center">
                            ...
                            <li>
                                <a class="CHATBOX_open nav-link-notify" href="#"> <img
                                        src="<?php echo base_url() ?>adminAssets/img/icon/msg.svg" alt=""> </a>
                            </li>
                                    ...
                                    <div class="Notification_body">
                                        ...
                                        <div class="single_notify d-flex align-items-center">
                                            <div class="notify_thumb">
                                                <a href="#"><img
                                                        src="<?php echo base_url() ?>adminAssets/img/staf/2.png"
                                                        alt=""></a>
                                            </div>
                                        ...
                                        <div class="single_notify d-flex align-items-center">
                                            <div class="notify_thumb">
                                                <a href="#"><img
                                                        src="<?php echo base_url() ?>adminAssets/img/staf/4.png"
                                                        alt=""></a>
                                            </div>
                                            <div class="notify_content">
                                                <a href="#">
                                        ...
                                        <div class="single_notify d-flex align-items-center">
                                            <div class="notify_thumb">
                                                <a href="#"><img
                                                        src="<?php echo base_url() ?>adminAssets/img/staf/3.png"
                                                        alt=""></a>
                                            </div>
                                            <div class="notify_content">
                                                <a href="#">
    ...
    <div class="main_content_iner overly_inner ">
        <div class="container-fluid p-0 ">
            <div class="row">
                ...
                <form action="<?php echo base_url('admin/Admin/add_product_category') ?>" method="post" enctype="multipart/form-data">
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <td><input type="submit" class="btn btn-primary" value="Insert"></td>
                        </tr>
                    </table>
                </form>
            </div>
            ...
            <div class="row">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php $sl=0; foreach($category_data as $c){ ?>
                            <tr>
                                <td><?php echo ++$sl ?></td>
                                <td><?php echo $c->name ?></td>
                                <td>
                                <img src="<?php echo base_url('product/category/') ?><?php echo $c->photo ?>" style="width:15%">    
                               </td>
                                <td>
                                <a href="<?php echo base_url() ?>admin/Admin/editCategory/<?php echo $c->id ?>" class="btn btn-info">Edit  </a>    
                                <a href="<?php echo base_url() ?>admin/Admin/deleteCategory/<?php echo $c->id ?>" class="btn btn-danger" onclick="return confirm('Are you sure!!')">Delete  </a>    
                                </td>
                            </tr>
                            <?php } ?>
                    </tbody>
