                        ...
                        <div class="col">
                            <div class="about-l">
                                <ul class="about-link">
                                    ...
                                    <li class="about-p"><span><?php echo $list->categoryName ?></span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-xl-6 col-md-6 col-12 col-xs-12 larg-image">
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="image-11">
                                        <a href="javascript:void(0)" class="long-img">
                                            <figure class="zoom" onmousemove="zoom(event)" style="background-image: url(<?php echo base_url('product/product/') ?><?php echo $list->photo_one ?>)">
                                                <img src="<?php echo base_url('product/product/') ?><?php echo $list->photo_one ?>" class="img-fluid" alt="image">
                                            </figure>
                                        </a>
                                    </div>
                                    <div class="tab-pane fade" id="image-22">
                                        <a href="javascript:void(0)" class="long-img">
                                            <figure class="zoom" onmousemove="zoom(event)" style="background-image: url(<?php echo base_url('product/product/') ?><?php echo $list->photo_two ?>)">
                                                <img src="<?php echo base_url('product/product/') ?><?php echo $list->photo_two ?>" class="img-fluid" alt="image">
                                            </figure>
                                        </a>
                                    </div>
                                ...
                                <ul class="nav nav-tabs pro-page-slider owl-carousel owl-theme">
                                    <li class="nav-item items">
                                        <a class="nav-link active" data-bs-toggle="tab" href="#image-11"><img src="<?php echo base_url('product/product/') ?><?php echo $list->photo_one ?>" class="img-fluid" alt="image"></a>
                                    </li>
                                    <li class="nav-item items">
                                        <a class="nav-link" data-bs-toggle="tab" href="#image-22"><img src="<?php echo base_url('product/product/') ?><?php echo $list->photo_two ?>" class="img-fluid" alt="iamge"></a>
                                    </li>
                                    <li class="nav-item items">
                                        <a class="nav-link" data-bs-toggle="tab" href="#image-33"><img src="<?php echo base_url('product/product/') ?><?php echo $list->photo_one ?>" class="img-fluid" alt="image"></a>
                                    </li>
                                    <li class="nav-item items">
                                        <a class="nav-link" data-bs-toggle="tab" href="#image-44"><img src="<?php echo base_url('product/product/') ?><?php echo $list->photo_two ?>" class="img-fluid" alt="image"></a>
                                    </li>
                                    <li class="nav-item items">
                                        <a class="nav-link" data-bs-toggle="tab" href="#image-55"><img src="<?php echo base_url('product/product/') ?><?php echo $list->photo_one ?>" class="img-fluid" alt="image"></a>
                                    </li>
                                    <li class="nav-item items">
                                        <a class="nav-link" data-bs-toggle="tab" href="#image-66"><img src="<?php echo base_url('product/product/') ?><?php echo $list->photo_two ?>" class="img-fluid" alt="image"></a>
                                    </li>
                                    <li class="nav-item items">
                                        <a class="nav-link" data-bs-toggle="tab" href="#image-77"><img src="<?php echo base_url('product/product/') ?><?php echo $list->photo_one ?>" class="img-fluid" alt="image"></a>
                                    </li>
                                    <li class="nav-item items">
                                        <a class="nav-link" data-bs-toggle="tab" href="#image-88"><img src="<?php echo base_url('product/product/') ?><?php echo $list->photo_two ?>" class="img-fluid" alt="image"></a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-lg-6 col-xl-6 col-md-6 col-12 col-xs-12 pro-info">
                                ...
                                <div class="pro-price">
                                    ...
                                    <span class="old-price"><del><?php if($list->tag!='New'){echo  500;}else{ echo ''; } ?></del></span>
                                    <div class="Pro-lable">
                                        <span class="p-discount"><?php if($list->tag!='New'){echo $list->tag; }else{ echo '0%'; } ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="pro-btn">
                                    ...
                                    <a href="<?php echo base_url('FrontEnd/addToCart/') ?><?php echo $list->id ?>" class="btn btn-style1"><i class="fa fa-shopping-bag"></i> Add to cart</a>
                                ...
                                <div class="pay-img">
                                    <a href="checkout-1.html">
                                        <img src="<?php echo base_url('FrontAssets/') ?>image/pay-image.jpg" class="img-fluid" alt="pay-image">
                                    </a>
                                </div>
                            </div>
                        </div>
