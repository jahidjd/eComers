                    ...
                    <div class="col">
                        <div class="about-l">
                            <ul class="about-link">
                                ...
                                <li class="about-p"><span>Shop</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid-list-area">
                        ...
                        <div class="grid-pro">
                            <ul class="grid-product">
                                <?php $sl=0; foreach($homeProduct as $p){ 
                                    $sl++;
                                    if($sl<13){?>
                                <li class="grid-items">
                                    <div class="tred-pro">
                                        <div class="tr-pro-img">
                                            <a href="<?php echo base_url('FrontEnd/productDetails/') ?><?php echo $p->id ?>">
                                                <img class="img-fluid" src="<?php echo base_url('product/product/') ?><?php echo $p->photo_one ?>" alt="pro-img1">
                                                <img class="img-fluid additional-image" src="<?php echo base_url('product/product/') ?><?php echo $p->photo_two ?>" alt="additional image">
                                            </a>
                                        </div>
                                        <div class="Pro-lable">
                                    ...
                                    <div class="caption">
                                        ...
                                        <div class="pro-price">
                                            ...
                                            <span class="old-price"><?php if($p->tag!='New'){ echo 500; } ?></span>
                                        </div>
                                    </div>
                                </li>
                             <?php  } } ?>
