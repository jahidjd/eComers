                    ...
                    <div class="col">
                        <div class="about-l">
                            <ul class="about-link">
                                ...
                                <li class="about-p"><span><?php echo @$list[0]->categoryName ?></span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4 col-12">
                    <div class="all-filter">
                        <div class="categories-page-filter">
                            ...
                            <?php foreach($productCategory as $cp){ ?>
                                <li class="grid-list-option">
                                    <input type="checkbox">
                                    <a href="<?php echo base_url('FrontEnd/categoryProduct/') ?><?php echo $cp->id ?>"><?php echo $cp->name ?> <span class="grid-items">(4)</span></a>
                                </li>
                               <?php } ?>
                            </ul>
                        </div>
                        ...
                        <div class="filter-banner">
                            <a href="grid-list.html" class="grid-banner">
                                <img src="<?php echo base_url('FrontAssets/') ?>image/grid-banner.jpg" class="img-fluid" alt="image">
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-9 col-md-8 col-12">
                    <div class="grid-list-banner" style="background-image: url(<?php echo base_url('FrontAssets/') ?>image/slider17.jpg);">
                            ...
                            <ul class="grid-product">
                                ...
                                <li class="grid-items">
                                    <div class="tred-pro">
                                        <div class="tr-pro-img">
                                            <a href="product.html">
                                                <img class="img-fluid" src="<?php echo base_url('product/product/') ?><?php echo $l->photo_one ?>" alt="pro-img1">
                                                <img class="img-fluid additional-image" src="<?php echo base_url('product/product/') ?><?php echo $l->photo_two ?>" alt="additional image">
                                            </a>
                                        </div>
                                        <div class="Pro-lable">
                                            <span class="p-text"><?php echo $l->tag ?></span>
                                        </div>
                                        <div class="pro-icn">
                                    ...
                                    <div class="caption">
                                        <h3><a href="product.html"><?php echo $l->name ?></a></h3>
                                        <div class="rating">
                                        ...
                                        <div class="pro-price">
                                            <span class="new-price"><?php echo $l->price ?>TK</span>
                                        </div>
                                    </div>
                                </li>
                                <?php  }else{?>
                                ...
                                <li class="grid-items">
                                    <div class="tred-pro">
                                        ...
                                        <div class="Pro-lable">
                                            <span class="p-discount"><?php echo $l->tag ?></span>
                                        </div>
                                        <div class="pro-icn">
                                            <a href="wishlist.html" class="w-c-q-icn"><i class="fa fa-heart"></i></a>
                                            <a href="cart.html" class="w-c-q-icn"><i class="fa fa-shopping-bag"></i></a>
                                    ...
                                    <div class="caption">
                                        ...
                                        <div class="pro-price">
                                            <span class="new-price"><?php echo $l->price ?> TK</span>
                                            <span class="old-price"><del>300 TK</del></span>
                                        </div>
                                    </div>
                                </li>
                              <?php } }?>
