<section class="footer-one section-tb-padding">
                        ...
                        <div class="f-logo">
                            <ul class="footer-ul">
                                <li class="footer-li footer-logo">
                                    <a href="index1.html">
                                        <img class="img-fluid" src="<?php echo base_url('FrontAssets/') ?>image/logo1.png" alt="">
                                    </a>
                                </li>
                    ...
                    <div class="col">
                        <ul class="f-bottom">
                            ...
                            <li class="f-c f-payment">
                                <a href="checkout-1.html"><img src="<?php echo base_url("FrontAssets/") ?>image/payment.png" class="img-fluid" alt="payment image"></a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="popup-content"> -->
                            ...
                            <!-- <div class="pop-up-newsletter" style="background-image: url(image/news-popup.jpg);">
                                <div class="logo-content">
                                    <a href="index1.html"><img src="<?php //echo base_url("FrontAssets/") ?>image/logo1.png" alt="image" class="img-fluid"></a>
        ...
        <!-- jquery -->
        <script src="<?php echo base_url('FrontAssets/') ?>js/modernizr-2.8.3.min.js"></script>
        ...
        <!-- popper -->
        <script src="<?php echo base_url('FrontAssets/') ?>js/popper.min.js"></script>
        <!-- fontawesome -->
        <script src="<?php echo base_url('FrontAssets/') ?>js/fontawesome.min.js"></script>
        <!-- owl carousal -->
        <script src="<?php echo base_url('FrontAssets/') ?>js/owl.carousel.min.js"></script>
        <!-- swiper -->
        <script src="<?php echo base_url('FrontAssets/') ?>js/swiper.min.js"></script>
        <!-- custom -->
